...
export function DashboardNav() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/60 bg-blue-500 py-4 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80 dark:border-slate-800/60 dark:bg-slate-900/80">
