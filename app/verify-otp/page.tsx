      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center flex">
            <p className="text-sm text-muted-foreground mb-0">{t("otp.didntReceive")}</p>
          ...
          <div className="mt-4 text-center">
            <Button variant="link" className="p-0 h-auto text-sm cursor-pointer" onClick={() => router.push("/register")}>
          ...
          <div className="mt-6 p-3 bg-blue-50 dark:bg-blue-950 rounded-lg">
            <p className="text-xs text-blue-600 dark:text-blue-400">
              <strong>Demo Note:</strong> Use code "123456" for testing purposes.
            </p>
          </div>
        </CardContent>
      </Card>
