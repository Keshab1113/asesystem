...
export default function UpcomingAssessmentsPage() {
  ...
  const getTimeUntilAssessment = (date: string, time: string) => {
  ...
  const AssessmentCard = ({ assessment }: { assessment: (typeof mockUpcomingAssessments)[0] }) => (
          ...
          <div className="border-t pt-4">
            <div className="flex items-center justify-between">
              <div className="text-sm">
                ...
                <span
                  className={`font-medium ${!isRegistrationOpen(assessment.registrationDeadline) ? "text-red-600" : ""}`}
                >
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight">Upcoming Assessments</h1>
        <p className="text-muted-foreground">View and register for future assessments and training sessions.</p>
      </div>
