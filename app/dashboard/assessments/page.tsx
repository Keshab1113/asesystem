...
export default function AssessmentsPage() {
  ...
  const filterAssessments = (assessments: typeof mockAssessments) => {
  ...
  const getStatusBadge = (assessment: (typeof mockAssessments)[0]) => {
  ...
  const AssessmentCard = ({ assessment }: { assessment: (typeof mockAssessments)[0] }) => (
