      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              {[
                { text: "At least 8 characters", check: passwords.new.length >= 8 },
                { text: "One lowercase letter", check: /[a-z]/.test(passwords.new) },
                { text: "One uppercase letter", check: /[A-Z]/.test(passwords.new) },
                { text: "One number", check: /\d/.test(passwords.new) },
                { text: "One special character", check: /[!@#$%^&*(),.?":{}|<>]/.test(passwords.new) },
            ...
            <Alert>
              ...
              <AlertDescription>
                Choose a strong password that you haven't used elsewhere. Avoid common words and personal information.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
