...
import { ConfirmationDialog } from "@/app/adminDashboard/components/confirmation-dialog"
...
export function BulkActionsToolbar({ selectedItems, onClearSelection, onBulkAction }: BulkActionsToolbarProps) {
